...
#if 1 /* << EST: configuration through properties */
#define MAX_ISR_NESTING %TraceMaxISRNesting
#else
...
#pragma MESSAGE DISABLE C5919 /* conversion of float to unsigned integral */
#endif
