 ...
 ******************************************************************************/
%if defined(RTTUpBufferIndex)
#define TRC_CFG_RTT_UP_BUFFER_INDEX       %RTTUpBufferIndex  /* << EST */
%else
 ...
 * If you prefer to use buffer 0, it must be configured in SEGGER_RTT_Conf.h. 
 ******************************************************************************/
%if defined(RTTDownBufferIndex)
#define TRC_CFG_RTT_DOWN_BUFFER_INDEX     %RTTDownBufferIndex   /* << EST */
%else
