...
#if 1 /* << EST */
#define NameLenTask       %NameLenTaskStr
#define NameLenISR        %NameLenISR
 ...
 *****************************************************************************/
#if 1 /* << EST */
#define TRACE_DESCRIPTION "%TraceDescriptionString"
#else
 ...
 *****************************************************************************/
#if 1 /* << EST */
#define TRACE_DESCRIPTION_MAX_LENGTH %TraceDescriptionMaxLength
#else
...
#if 1 /* << EST */
#define TRACE_DATA_ALLOCATION %TraceDataAllocation
#else
 ...
 *****************************************************************************/
#if 1 /* << EST */
#define STOP_AFTER_N_EVENTS %StopAfterNevents
#else
