...
- trcKernelPortXXXXXX.c/.h  	- Kernel-specific trace macros and helper functions.
- trcKernelHooks.h        		- Generic trace macros (OS independent), used by trcKernelPortXXXXXX.
