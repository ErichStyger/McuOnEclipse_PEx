...
#define	_USE_STRFUNC	%UseStringFunctions
...
#define	_USE_LFN	%UseLFN
#define	_MAX_LFN	%MaxLFN
...
#define _FS_TIMEOUT          %TimeoutTicks /* Timeout period in unit of time ticks */
%if defined(RTOS)
#define _SYNC_t              void* /* Type of sync object used on the OS. In reality it is xSemaphoreHandle  */
%else
#define _SYNC_t              %HandleStr        /* O/S dependent type of sync object. e.g. HANDLE, OS_EVENT*, ID and etc.. */
%endif
%else
