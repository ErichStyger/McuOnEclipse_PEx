...
%elif (CPUDevice="Kinetis K20D50") | (CPUDevice="Kinetis K20D72") | (CPUDevice="Kinetis K21D50") | (CPUDevice="Kinetis K21F120") | (CPUDevice="Kinetis K22F120") | (CPUDevice="Kinetis K22FN120") | (CPUDevice="Kinetis K24FN120") | (CPUDevice="Kinetis K40") | (CPUDevice="Kinetis K53") | (CPUDevice="Kinetis K60") | (CPUDevice="Kinetis K64F")  | (CPUDevice="Kinetis K70") | (CPUDevice="Kinetis L2K") | (CPUDevice="Kinetis KL24Z48") | (CPUDevice="Kinetis KL26Z48") | (CPUDevice="Kinetis KL46Z48")
...
%- \Device\app\cdc\cw10\kinetis_k20_72MHz -------------------------------------------
  %FILE? %'DirRel_Code'derivative.h
  %include FSL_USB_Stack\Device\app\cdc\cw10\kinetis_k20_72MHz\derivative.h
%elif (CPUDevice="Kinetis K21D50") | (CPUDevice="Kinetis K21F120")
...
%- \Device\app\cdc\cw10\kinetis_k22FN -------------------------------------------
  %FILE? %'DirRel_Code'derivative.h
  %include FSL_USB_Stack\Device\app\cdc\cw10\kinetis_k22fn\derivative.h
%elif (CPUDevice="Kinetis K24FN120")
%- \Device\app\cdc\cw10\kinetis_k24FN -------------------------------------------
  %FILE? %'DirRel_Code'derivative.h
  %include FSL_USB_Stack\Device\app\cdc\cw10\kinetis_k24fn\derivative.h
...
%- \Device\app\cdc\cw10\kinetis_k64f -------------------------------------------
  %FILE? %'DirRel_Code'derivative.h
  %include FSL_USB_Stack\Device\app\cdc\cw10\kinetis_k64f\derivative.h
...
%- \Device\app\cdc\cw10\kinetis_kl24z48 -------------------------------------------
  %FILE? %'DirRel_Code'derivative.h
  %include FSL_USB_Stack\Device\app\cdc\cw10\kinetis_kl24z48\derivative.h
%elif CPUDevice="Kinetis KL26Z48"
%- \Device\app\cdc\cw10\kinetis_kl26z48 -------------------------------------------
  %FILE? %'DirRel_Code'derivative.h
  %include FSL_USB_Stack\Device\app\cdc\cw10\kinetis_kl26z48\derivative.h
...
%else
  %error (FSL_USB_Stack_Files_Device.prg) unknown CPU %CPUDevice
%endif
