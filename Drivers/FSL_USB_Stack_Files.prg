...
%elif (USBDeviceClass="CDC Device") | (USBDeviceClass="MSD Device") | (USBDeviceClass="HID Keyboard Device") | (USBDeviceClass="HID Joystick Device") | (USBDeviceClass="HID Mouse Device") %- USB Device
