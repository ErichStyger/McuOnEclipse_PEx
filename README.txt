...
CriticalSection			EnterCritical() and ExitCritical() implemenation.
...
KinetisSDK			Wrapper component needed for using Kinetis SDK.
KinetisTools			Utility functions for Kinetis family of microprocessors.
...
minIni				Minimal .ini file implementation.
...
OneWire				One-Wire communication driver (experimental).
...
RNet				Radio remote wireless network stack.
